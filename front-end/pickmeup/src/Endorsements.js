...
<<<<<<< HEAD
          ...
          <div className='title-card'>
            <h2 className='name'>Alyssa Ebert</h2>
            <p>Any guy who is worth your time has got to have the best lines. If his pick-up game is weak you know his pull-out is too. Don't trust a homie who can't even download the hottest app on the marketplace. If he ain't buyin' (for the low-low price of $4.99) then you sure as hell shouldn't be supplyin.</p>
            <img className='img' src=""/>
          </div>
          <div className='title-card'>
            <h2 className='name'>Matt Winzer</h2>
            <p>I don't use that app. Haven't had a girlfriend for YEARS. 1/10 would not reccomend going without it.</p>
            <img className='img' src=""/>
          </div>
          <div className='title-card'>
